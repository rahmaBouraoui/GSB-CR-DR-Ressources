...
INSERT INTO `OFFRIR` VALUES ('a17',4,'3MYC7',2),('a17',4,'AMOX45',3),('b59',103,'3MYC7',15),('b59',103,'AMOX45',20);
...
CREATE TABLE `RAPPORT_VISITE` (
  ...
  `RAP_MOTIF` varchar(40) DEFAULT '',
  `RAP_COEFCONFIANCE` int(1) DEFAULT '1',
  `RAP_DATEVISITE` date NOT NULL DEFAULT '0000-00-00',
  `RAP_DATEREDACTION` date NOT NULL,
  `RAP_LU` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `RAPPORT_VISITE` VALUES ('a17',4,83,'','',1,'2015-02-24','2015-02-24',0),('b59',1,82,'','',1,'2015-02-24','2015-02-24',0),('b59',100,84,'','',1,'2015-01-02','2015-01-03',1),('b59',101,85,'','',2,'2015-01-01','2015-01-03',1),('b59',102,85,'','',1,'2015-01-05','2015-01-07',1),('b59',103,84,'','',1,'2015-02-05','2015-02-07',1),('b59',110,84,'','',1,'2015-02-05','2015-02-24',1),('b59',111,84,'','',1,'2015-01-05','2015-02-24',1),('b59',112,84,'','',2,'2015-11-19','0000-00-00',0);
...
CREATE TABLE `VISITEUR` (
  ...
  `VIS_LOGIN` varchar(20) DEFAULT NULL,
  `VIS_MDP` varchar(20) DEFAULT 'azerty',
...
INSERT INTO `VISITEUR` VALUES ('a131','Villechalane','Louis','8 cours Lafontaine','29000','BREST','2012-11-08',NULL,'SW',NULL,'azerty'),('a17','Andre','David','1 rue Aimon de Chissee','38100','GRENOBLE','2008-06-19',NULL,'GY','dandre','azerty'),('a55','Bedos','Christian','1 rue Bénédictins','65000','TARBES','2007-09-07',NULL,'GY',NULL,'azerty'),('a93','Tusseau','Louis','22 rue Renou','86000','POITIERS','2001-02-09',NULL,'SW',NULL,'azerty'),('b13','Bentot','Pascal','11 avenue 6 Juin','67000','STRASBOURG','2003-11-06',NULL,'GY',NULL,'azerty'),('b16','Bioret','Luc','1 rue Linne','35000','RENNES','2003-01-06',NULL,'SW',NULL,'azerty'),('b19','Bunisset','Francis','10 rue Nicolas Chorier','85000','LA ROCHE SUR YON','2013-09-23',NULL,'GY',NULL,'azerty'),('b25','Bunisset','Denise','1 rue Lionne','49100','ANGERS','2007-03-04',NULL,'SW',NULL,'azerty'),('b28','Cacheux','Bernard','114 rue Authie','34000','MONTPELLIER','2008-02-10',NULL,'GY',NULL,'azerty'),('b34','Cadic','Eric','123 rue Caponière','41000','BLOIS','2012-06-03','P','SW','ecadic','azerty'),('b4','Charoze','Catherine','100 place Géants','33000','BORDEAUX','2009-05-07',NULL,'SW',NULL,'azerty'),('b50','Clepkens','Christophe','12 rue Fédérico Garcia Lorca','13000','MARSEILLE','2011-08-18',NULL,'SW',NULL,'azerty'),('b59','Cottin','Vincenne','36 square Capucins','5000','GAP','2010-12-19',NULL,'GY',NULL,'azerty'),('c14','Daburon','François','13 rue Champs Elysées','6000','NICE','2012-01-20','S','SW',NULL,'azerty'),('c3','De','Philippe','13 rue Charles Peguy','10000','TROYES','2005-05-29',NULL,'SW',NULL,'azerty'),('c54','Debelle','Michel','181 rue Caponière','88000','EPINAL','2004-09-19',NULL,'SW',NULL,'azerty'),('d13','Debelle','Jeanne','134 rue Stalingrad','44000','NANTES','2012-05-25',NULL,'SW',NULL,'azerty'),('d51','Debroise','Michel','2 avenue 6 Juin','70000','VESOUL','2011-08-17','E','GY',NULL,'azerty'),('e22','Desmarquest','Nathalie','14 rue Fédérico Garcia Lorca','54000','NANCY','2013-04-18',NULL,'GY',NULL,'azerty'),('e24','Desnost','Pierre','16 rue Barral de Montferrat','55000','VERDUN','2013-04-18','E','SW',NULL,'azerty'),('e39','Dudouit','Frédéric','18 quai Xavier Jouvin','75000','PARIS','2013-04-18',NULL,'GY',NULL,'azerty'),('e49','Duncombe','Claude','19 avenue Alsace Lorraine','9000','FOIX','2012-09-16',NULL,'GY',NULL,'azerty'),('e5','Enault-Pascreau','Céline','25B rue Stalingrad','40000','MONT DE MARSAN','2012-09-16','S','GY',NULL,'azerty'),('e52','Eynde','Valérie','3 rue Henri Moissan','76000','ROUEN','2012-09-16',NULL,'GY',NULL,'azerty'),('f21','Finck','Jacques','route Montreuil Bellay','74000','ANNECY','2012-09-16',NULL,'SW',NULL,'azerty'),('f39','Frémont','Fernande','4 rue Jean Giono','69000','LYON','2005-05-29',NULL,'GY',NULL,'azerty'),('f4','Gest','Alain','30 rue Authie','46000','FIGEAC','2005-05-29',NULL,'GY',NULL,'azerty'),('g19','Gheysen','Galassus','32 boulevard Mar Foch','75000','PARIS','2005-05-29',NULL,'SW',NULL,'azerty'),('g30','Girard','Yvon','31 avenue du 6 Juin','80000','AMIENS','2012-05-25','N','GY',NULL,'azerty'),('g53','Gombert','Luc','32 rue Emile Gueymard','56000','VANNES','2012-05-25',NULL,'GY',NULL,'azerty'),('g7','Guindon','Caroline','40 rue Mar Montgomery','87000','LIMOGES','2012-05-25',NULL,'GY',NULL,'azerty'),('h13','Guindon','François','44 rue Picotière','19000','TULLE','2012-05-25',NULL,'SW',NULL,'azerty'),('h30','Igigabel','Guy','33 rue Arlequin','94000','CRETEIL','2008-06-19',NULL,'SW',NULL,'azerty'),('h35','Jourdren','Pierre','34 avenue Jean Perrot','15000','AURRILLAC','2008-06-19',NULL,'GY',NULL,'azerty'),('h40','Juttard','Pierre-Raoul','34 cours Jean Jaurès','8000','SEDAN','2008-06-19',NULL,'GY',NULL,'azerty'),('j45','Euré-Morel','Saout','38 cours Berriat','52000','CHAUMONT','2008-06-19','N','SW',NULL,'azerty'),('j50','Landré','Philippe','4 avenue du Général Laperrine','59000','LILLE','2000-05-01',NULL,'GY',NULL,'azerty'),('j8','Langeard','Hugues','39 avenue Jean Perrot','93000','BAGNOLET','2000-05-01','P','GY',NULL,'azerty'),('k4','Lanne','Bernard','4 rue Bayeux','30000','NIMES','2000-05-01',NULL,'SW',NULL,'azerty'),('k53','Le','Noël','4 avenue Beauvert','68000','MULHOUSE','2000-05-01',NULL,'SW',NULL,'azerty'),('l14','Le','Jean','39 rue Raspail','53000','LAVAL','2000-05-01',NULL,'SW',NULL,'azerty'),('l23','Leclercq','Servane','11 rue Quinconce','18000','BOURGES','1998-11-23',NULL,'SW',NULL,'azerty'),('l46','Lecornu','Jean-Bernard','4 boulevard du Maréchal Foch','72000','LA FERTE BERNARD','1998-11-23',NULL,'GY',NULL,'azerty'),('l56','Lecornu','Ludovic','4 rue Abel Servien','25000','BESANCON','1998-11-23',NULL,'SW',NULL,'azerty'),('m35','Lejard','Agnès','4 rue Anthoard','82000','MONTAUBAN','1998-11-23',NULL,'SW',NULL,'azerty'),('m45','Lesaulnier','Pascal','47 rue Thiers','57000','METZ','1998-11-23',NULL,'SW',NULL,'azerty'),('n42','Letessier','Stéphane','5 chemin de Capuche','27000','EVREUX','1998-11-23',NULL,'GY',NULL,'azerty'),('n58','Loirat','Didier','12 avenue Bourg la Croix','45000','ORLEANS','1998-11-23',NULL,'GY',NULL,'azerty'),('n59','Maffezzoli','Thibaud','5 rue Chateaubriand','2000','LAON','2005-12-21',NULL,'SW',NULL,'azerty'),('o26','Mancini','Anne','5 rue D\'\'Agier','48000','MENDE','2005-12-21',NULL,'GY',NULL,'azerty'),('p32','Marcouiller','Gérard','7 place St Gilles','91000','ISSY LES MOULINEAUX','2005-12-21',NULL,'GY',NULL,'azerty'),('p40','Michel','Jean-Claude','5 rue Gabriel Péri','61000','FLERS','2005-12-21','O','SW',NULL,'azerty'),('p41','Montecot','Françoise','6 rue Paul Valéry','17000','SAINTES','2005-12-21',NULL,'GY',NULL,'azerty'),('p42','Notini','Veronique','5 rue du Lieutenant Chabal','60000','BEAUVAIS','2005-12-21',NULL,'SW',NULL,'azerty'),('p49','Onfroy','Den','5 rue Sidonie Jacolin','37000','TOURS','2005-12-21',NULL,'GY',NULL,'azerty'),('p6','Pascreau','Charles','57 boulevard Mar Foch','64000','PAU','1997-03-30',NULL,'SW',NULL,'azerty'),('p7','Pernot','Claude-Noël','6 rue Alexandre 1 de Yougoslavie','11000','NARBONNE','2003-01-02',NULL,'SW',NULL,'azerty'),('p8','Perrier','Maître','6 rue Aubert Dubayet','71000','CHALON SUR SAONE','2006-06-23',NULL,'GY',NULL,'azerty'),('q17','Petit','Jean-Louis','7 rue Ernest Renan','50000','SAINT LO','2009-06-07',NULL,'GY',NULL,'azerty'),('r24','Piquery','Patrick','9 rue Vaucelles','14000','CAEN','2007-04-29','O','GY',NULL,'azerty'),('r58','Quiquandon','Joëll','7 rue Ernest Renan','29000','QUIMPER','2006-09-30',NULL,'GY',NULL,'azerty'),('s10','Retailleau','Josselin','88 bis rue Saumuroise','39000','DOLE','2011-12-05',NULL,'SW',NULL,'azerty'),('s21','Retailleau','Pascal','32 boulevard Ayrault','23000','MONTLUCON','2009-05-09',NULL,'SW',NULL,'azerty'),('t43','Souron','Maryse','7B rue Gay Lussac','21000','DIJON','2003-09-03',NULL,'SW',NULL,'azerty'),('t47','Tiphagne','Patrick','7B rue Gay Lussac','62000','ARRAS','1997-08-29',NULL,'SW',NULL,'azerty'),('t55','Tréhet','Alain','7D chemin Barral','12000','RODEZ','1994-11-29',NULL,'SW',NULL,'azerty'),('t60','Tusseau','Josselin','63 rue Bon Repos','28000','CHARTRES','1991-03-29',NULL,'GY',NULL,'azerty');
...
-- Dump completed on 2016-04-07 15:43:25
